...
;(function($) {
	$.fn.camera = function(opts, callback) {
		...
		fakeHover.append('<div class="container"><div class="row"><div class="span16"></div></div></div>');
		
		fakeHover.find('.span16').append('<div class="camera_target_content"></div>');
		...
		if (opts.playPause == true) {
			fakeHover.find('.span16').append('<div class="camera_commands"></div>')
		}

		if (opts.navigation == true) {
			fakeHover.find('.span16').append('<div class="camera_prev"><span></span></div>').append('<div class="camera_next"><span></span></div>');
		}
