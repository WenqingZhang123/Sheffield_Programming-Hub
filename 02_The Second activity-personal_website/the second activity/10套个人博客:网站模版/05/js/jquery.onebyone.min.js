...
;(function($) {	
	...
	var easeTypeArr = ['fadeIn', 'fadeInUp', 'fadeInDown', 'fadeInLeft', 'fadeInRight', 'fadeInRight'];
    ...
    $.fn.oneByOne = function(options) {  
		...
		if(settings.showArrow){
			arrowButton = $('<div class="arrowButton"><div class="pauseArrow pause"></div><div class="prevArrow"></div><div class="nextArrow"></div></div>');
			parent.append(arrowButton);
            var _next = $('.nextArrow', arrowButton).bind('click', function(event) {
				nextBanner();
				$('.pauseArrow').addClass('pause');
            });
			var _pause = $('.pauseArrow', arrowButton).bind('click', function(event) {
			...
			var _pauseInput = $('textarea', this ).bind('click', function(event) {
					stopSlideShow();
					
					$(this).parents('.oneByOne1').find('.pauseArrow').removeClass('pause')
